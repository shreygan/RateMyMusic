...
<template>
  ...
  >
    <b-navbar-brand to="/" style="color: white; font-size: x-large"
      >RateMyMusic</b-navbar-brand
    >
    ...
    <b-collapse id="nav-collapse" is-nav>
      <b-navbar-nav>
        ...
        <b-nav-item to="/UserCharts"
          ><span class="p">UserCharts</span></b-nav-item
        >
        <b-nav-item to="/Playlists"
          ><span class="p">Playlists</span></b-nav-item
        >
      ...
      <b-navbar-nav class="justify-content-end" style="flex: 1">
        <b-nav-item-dropdown
          :toggle-class="{ 'white-dropdown-arrow': isWhiteArrow }"
          right
        >
          <template #button-content>
            <BImg
              v-if="currentUser.name && currentUser.profile_pic"
          ...
          <b-dropdown-item v-if="!userPid" class="navlinks" href="/users/create"
            >Create an Account</b-dropdown-item
          >
          <b-dropdown-item v-if="!userPid" class="navlinks" href="/users/login"

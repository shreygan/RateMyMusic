  ...
  <BCol v-for="(users, index) in allUsers" :key="index" class="mb-3">
    <BCard style="width: 100%; margin-top: 15%">
      <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <RouterLink
          :to="{ name: '/users/[user]', params: { user: users.pid } }"
        >
      ...
      <b-card-img
        v-if="users.profile_pic"
        :src="arrayBufferToBase64(users.profile_pic.data)"
        alt="Album Cover"
      ></b-card-img>
      ...
      <BButton style="margin-top: -3%" variant="primary" class="btn-bottom-left"
        >Follow User</BButton
      >
    </BCard>
  </BCol>
